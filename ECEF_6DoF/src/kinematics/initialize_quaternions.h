...
{ 
	...
	Quaternion q_x_body_2_ll (cos(s_data->roll_rad/2), sin(s_data->roll_rad/2), 0, 0); 
	Quaternion q_y_body_2_ll (cos(s_data->pitch_rad/2), 0, sin(s_data->pitch_rad/2), 0); 
	Quaternion q_z_body_2_ll (cos(s_data->yaw_rad/2), 0, 0, sin(s_data->yaw_rad/2)); 
	...
	q_body_2_ll_result.normalize();
	s_data->q_body_2_ll = q_body_2_ll_result; 
	...
	q_ll_2_ecef_result.normalize();
	s_data->q_ll_2_ecef = q_ll_2_ecef_result; 
}
